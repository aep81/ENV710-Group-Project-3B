...
Model1 <- lm(Log_Unfiltered_TN_ugL ~ Log_SpCond_mScm+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL,data = Log_Combined)

Model2 <- lm(Log_Unfiltered_TN_ugL ~ Log_Cond_mScm+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL,data = Log_Combined)

Model3 <- lm(Log_Unfiltered_TN_ugL ~ Log_Sal_ppt+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL,data = Log_Combined)
...
#Run GLS
GLS1 <- gls(Log_Unfiltered_TN_ugL ~ Log_SpCond_mScm+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL,data = Log_Combined)
GLS2 <- gls(Log_Unfiltered_TN_ugL ~ Log_Cond_mScm+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL,data = Log_Combined)
GLS3 <- gls(Log_Unfiltered_TN_ugL ~ Log_Sal_ppt+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL,data = Log_Combined)
...
MEM1 <- lme(Log_Unfiltered_TN_ugL ~ Log_SpCond_mScm+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL, random=~1|Site, data = Log_Combined)
MEM2 <- lme(Log_Unfiltered_TN_ugL ~ Log_Cond_mScm+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL,random=~1|Site, data = Log_Combined)
MEM3 <- lme(Log_Unfiltered_TN_ugL ~ Log_Sal_ppt+Log_TDS_mgl+DO_mgL+pH+Season+Log_TSS_mgL,random=~1|Site, data = Log_Combined)
...
fig1 <- ggplot(Log_Combined, aes(x=Log_Cond_mScm, y=Log_Unfiltered_TN_ugL))+
  geom_boxplot(width=0.2) +
  geom_jitter(aes(color=Site), size=3, width = 0.10) +
  scale_color_manual(values=c("#D2691E","#D2691E","#D2691E","#D2691E","#FAEBD7","#458B74","#0000FF","#0000FF","#0000FF","#FF7256","#FF4040","#00CDCD","#00CDCD","#556B2F","#FF7F00","#B23AEE", "#FF1493","#FF1493","#FF1493","#FF1493")) +
  labs(x="Conductivity(mS/cm)",y="Total Unfiltered Nitrogen (ug/L)") +
  theme_bw()
