...
hogfarm_alllocs_N$Month <- factor(hogfarm_alllocs_N$Month, 
...
N_hog_plot2 <- ggplot(hogfarm_alllocs_N, aes(x = Month, y = TotalN)) +
  #geom_point()+
  geom_boxplot()+
  labs(title = "Hog Farm Upper Total Nitrogen by Month",
       x = "Month",
       y = "Total N (mg/L)",
       caption = "Figure 2: Total Nitrogen concentrations at the Hog Farm Upper site over the course \n of the year. Summed ammonia, nitrate, and nitrite concentrations were used \n to represent the total nitrogen value. Monthly values included \n 'upstream', 'downstream', and 'further downstream' measurements."
  )+
  theme_bw()+
