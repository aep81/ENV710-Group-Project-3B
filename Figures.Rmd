...
Hogfarm_Lead_Fig <- ggplot() +
  ...
  labs(x="Reach",
       y="Pb Concentrations (ppb)", caption = "Distributions of lead concentrations (ppb) in upstream, downstream, and father downstream of Hogfarm headwaters in the Coastal Plains.") +
  theme_bw() +
  theme(legend.position = "none")

Hogfarm_Lead_Fig

ggsave(Hogfarm_Lead_Fig, filename="Hogfarm_Lead_Fig.jpg", height=12, width=25, units="cm")
