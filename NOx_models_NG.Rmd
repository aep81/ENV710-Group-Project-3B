...
decided to not do/ can write in future directions maybe
...
tbl_regression(nox.lmm3, tidy_fun = broom.helpers::tidy_parameters)
...
ggplot(wetlands, aes(x = predicted_nox, y = Log_Filtered_NOx_ugL)) +
  geom_point(alpha = 0.4) +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed", color = "red") +
  theme_minimal() +
  labs(title = "Predicted vs Observed NOₓ",
       x = "Predicted Log(NOₓ µg/L)",
       y = "Observed Log(NOₓ µg/L)")
